<html>
    ...
    <div class="row divBodyQuemSomos">    
        <div class="col l4 s12 m6 ">
            <img src="../imagens/art.jpg" class="imagemQuemSomos" >
        </div>
        <div class="col l8 s12 m16">
            <span class="spanQuemSomos">
                <h1 class="fontUbuntu">Quem somos</h1>
                <h6 class="fontMontserrat">
                    O Projeto <b>Arte Cidadã</b> trabalha diretamente com pessoas em situação de risco social, com cursos, palestras e reforço escolar para crianças, além de apoio sócio educativo para suas famílias, também atinge diretamente a nutrição e higiene de seus atendidos, fornecendo cestas básicas e material de higiene pessoal.O Projeto <b>Arte Cidadã</b> trabalha diretamente com pessoas em situação de risco social, com cursos, palestras e reforço escolar para crianças, além de apoio sócio educativo para suas famílias, também atinge diretamente a nutrição e higiene de seus atendidos, fornecendo cestas básicas e material de higiene pessoal.O Projeto <b>Arte Cidadã</b> trabalha diretamente com pessoas em situação de risco social, com cursos, palestras e reforço escolar para crianças, além de apoio sócio educativo para suas famílias, também atinge diretamente a nutrição e higiene de seus atendidos, fornecendo cestas básicas e material de higiene pessoal.O Projeto <b>Arte Cidadã</b> trabalha diretamente com pessoas em situação de risco social, com cursos, palestras e reforço escolar para crianças, além de apoio sócio educativo para suas famílias, também atinge diretamente a nutrição e higiene de seus atendidos, fornecendo cestas básicas e material de higiene pessoal.
                </h6>
            </span>
        </div>
    </div>
